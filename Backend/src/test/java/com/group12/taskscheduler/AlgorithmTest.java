...
//         // Task 4 is skipped since including it would prevent task 3 due to deadline or duration limits.
...
//         for (Task task : tasks) {
//             String deps = task.getDependenciesSetString() != null ? task.getDependenciesSetString() : "None";
